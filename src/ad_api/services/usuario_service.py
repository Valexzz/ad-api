...
from ad_api.domain.model import PoliticaSenha, Usuario
from ad_api.domain.ports import UsuarioRepository
from ad_api.errors import UsuarioJaExisteError, UsuarioNaoEncontradoError
...
class UsuarioService:
    ...
    def __init__(self, usuario_repository: UsuarioRepository, politica_senha: PoliticaSenha):
    ...
    def criar_usuario(
        ...
        logger.debug(f"[CRIAR_USUARIO_SERVICE] - Enviando criação para o repositório (Container explícito: {container_dn})")
